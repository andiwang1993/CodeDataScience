...
### user data
filenames <- c("normal_search_exe2_5_sigma_0.1.RData","normal_search_exe2_5_sigma_1.RData","random_search_exe2_5.RData","cmaes_exe2_5.RData","lbfgs_exe2_5.RData")
#filenames <- c("./normal_search_quadratic_5_sigma_0.3.RData","./normal_search_quadratic_5_sigma_3.RData")
#filenames <- c("./normal_search_ackley_5_sigma_1.RData","./normal_search_ackley_5_sigma_5.RData")
...
legend(x="topright", legend=thelegends, col=seq(1,no_files),lty=rep(1,no_files) , cex=0.4, text.width=txtwdth)
